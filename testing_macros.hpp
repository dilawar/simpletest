...
#define EXPECT_GT(a, b, token)  \
    if( (a) <= (b)) { \
        ostringstream ss; \
        LOCATION(ss); \
        ss << "Expected greater than " << a << ", received " << b << endl; \
        ss << token << endl; \
        dump(ss.str(), "EXPECT_FAILURE"); \
    }
...
#define EXPECT_GTE(a, b, token)  \
    if( (a) < (b)) { \
        ostringstream ss; \
        LOCATION(ss); \
        ss << "Expected greater than or equal to " << a << ", received " << b << endl; \
        ss << token << endl; \
        dump(ss.str(), "EXPECT_FAILURE"); \
    }
...
#define EXPECT_LT(a, b, token)  \
    if( (a) >= (b)) { \
        ostringstream ss; \
        LOCATION(ss); \
        ss << "Expected less than " << a << ", received " << b << endl; \
        ss << token << endl; \
        dump(ss.str(), "EXPECT_FAILURE"); \
    }
...
#define EXPECT_LTE(a, b, token)  \
    if( (a) < (b)) { \
        ostringstream ss; \
        LOCATION(ss); \
        ss << "Expected less than or equal to " << a << ", received " << b << endl; \
        ss << token << endl; \
        dump(ss.str(), "EXPECT_FAILURE"); \
    }
